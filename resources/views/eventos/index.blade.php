    ...
    <section class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div>
            ...
            <p class="text-slate-600 mt-1">
                Gerencie as palestras, semanas acadêmicas e atividades extracurriculares.
            </p>
        </div>

        <a
            href="/eventos/novo"
            class="rounded-lg bg-slate-900 px-4 py-2 font-medium text-white hover:bg-slate-700 transition-colors"
        >
            Novo Evento
        </a>
                        ...
                        <tr>
                            ...
                            >
                                ...
                                @if(!empty($busca))
                                    ...
                                    "<strong class="text-slate-700">{{ $busca }}</strong>".
